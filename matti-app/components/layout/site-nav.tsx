    ...
    <header className="sticky top-0 z-50 bg-gradient-to-r from-blue-50/90 via-white/90 to-purple-50/90 backdrop-blur-md border-b border-blue-100/60 shadow-sm">
      <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link
            href="/dashboard"
            className="text-sm font-medium text-gray-600 hover:text-gray-900 bg-gray-100 hover:bg-gray-200 px-3 py-2 rounded-xl transition-colors"
          >
            App →
          </Link>
        </div>
      ...
      {open && (
        <div className="md:hidden border-t border-blue-100/60 bg-white/95 backdrop-blur-md px-6 py-4 space-y-3">
          ...
          <div className="border-t border-gray-100 pt-3 flex flex-col gap-2">
            ...
            <Link href="/dashboard" className="bg-gray-100 text-gray-700 text-sm font-medium px-4 py-2.5 rounded-xl text-center" onClick={() => setOpen(false)}>App öffnen →</Link>
          </div>
        </div>
      )}
    </header>
